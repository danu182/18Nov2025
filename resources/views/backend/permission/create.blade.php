            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{-- Formulir untuk menyimpan Izin baru --}}
                        <form action="{{ route('permissions.store') }}" method="POST">
                            ...
                            {{-- Input Guard Name (Opsional, default 'web') --}}
                            <div class="form-group">
                                <label for="guard_name">Guard Name (Opsional)</label>
                                <input 
                                    type="text" 
...
{{-- Tidak ada script-bawah yang diperlukan untuk halaman create --}}
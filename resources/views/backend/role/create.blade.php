    ...
    <div class="page-inner">
        ...
        <div class="page-header">
            ...
            <ul class="breadcrumbs mb-3">
                ...
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="#">Tambah Role</a></li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header"><h4 class="card-title">Tambah Role Baru</h4></div>
                    <div class="card-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input 
                                                    ...
                                                    {{-- Logic untuk mempertahankan pilihan jika validasi gagal --}}
